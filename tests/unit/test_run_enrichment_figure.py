...
# observed -> no bar), and the SignalP third predictor (incl. an inf-fold self row
# and a low-fold n.s. T3SS contrast).
_STATS_ROWS = [
    ...
    # Combined rows (one per type) — only plotted by --combined. Window types carry
    # the DLP-or-DSE score; the T5aSS self row carries the SignalP score (decision 4).
